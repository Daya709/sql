...
SELECT customer_first_name, customer_last_name, customer.customer_id,sum(quantity* cost_to_customer_per_qty) as TotalPurchase
from customer 
...
-- zero value return as no data entered for 2022
